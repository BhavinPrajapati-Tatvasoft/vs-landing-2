...
!(function (D, u) {
  ...
  function C(D, u, e, F, i, C, n) {
    ...
    for (
      J && (I = I.split("++").join("")),
        ...
        o = (r = D.getElementsByTagName("*")).length,
        p = [],
        E = 0;
      E < o;
      E++
        ...
        ((d = (l = p[E]).parentNode === D) || G || (q && !P)) &&
          ...
          R &&
            (((l._isSplit && d) ||
              ...
              (a.push(l), (l._x -= S), z(l, D, V) && (l._wordEnd = !0)),
            "BR" === l.nodeName &&
    ...
    for (E = 0; E < o; E++)
      if (((d = (l = p[E]).parentNode === D), "BR" !== l.nodeName))
        if (
          ...
          if (l._isSplit)
            for (
              l._next = r = l.nextSibling, l.parentNode.appendChild(l);
              r && 3 === r.nodeType && " " === r.textContent;

            )
              (l._next = r.nextSibling),
                l.parentNode.appendChild(r),
                (r = r.nextSibling);
          else
            l.parentNode._isSplit
          ...
          l.parentNode._isSplit && !l._isSplit && "" !== l.innerHTML
            ...
            : q &&
              !l._isSplit &&
              ("span" === j && (l.style.display = "inline"), O.push(l));
      else
        R || G
          ? (l.parentNode && l.parentNode.removeChild(l), p.splice(E--, 1), o--)
          : P || D.appendChild(l);
    ...
    if (R) {
      for (
        G &&
          ...
          D.appendChild(c),
          (g = c.offsetWidth + "px"),
          (v = c.offsetParent === D ? 0 : D.offsetLeft),
          D.removeChild(c)),
          f = D.style.cssText,
      ...
      for (h = " " === V && (!G || (!P && !q)), E = 0; E < R.length; E++) {
        for (
          ...
          "BR" !== a[r].nodeName &&
            ...
            G &&
              (0 === r &&
                ((c.style.top = l._y + "px"), (c.style.left = S + v + "px")),
              (l.style.top = "0px"),
    ...
    G &&
      ...
      C > D.clientWidth &&
        ...
        D.clientWidth < C && (D.style.width = C + m + "px"))),
  ...
  function D(D, e, F, i) {
    ...
    for (
      ...
      if (((o = C.charAt(s)), g && (p = g(C.substr(s), e.specialChars))))
        (o = C.substr(s, p || 1)),
          (n += a && " " !== o ? i() + o + "</" + d + ">" : o),
          (s += p - 1);
        ...
        "{" === o && "{{LT}}" === C.substr(s, 6)
          ...
          ? ((E = ((C.substr(s, 12).split(S) || [])[1] || "").length || 2),
            (n +=
              a && " " !== o
                ? i() + C.substr(s, E) + "</" + d + ">"
                : C.substr(s, E)),
    ...
    h = (function (D) {
      var u = "undefined" != typeof window,
        e =
          ...
          -1 !== D.indexOf(p(49, 50, 55, 46, 48, 32, 48, 46, 49)),
        t = [
          a,
